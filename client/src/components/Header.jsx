const Header = () => {
  return (
    <div className="fixed header rounded-3xl ml-75">
      <div className="border-b-1 w-3/4 m-auto">
        <div className="flex flex-col items-center">
          <img
            className="mt-15 h-40 w-40 rounded-lg m-auto"
            src={new URL(`../assets/portpic.JPG`, import.meta.url).href}
          />
      ...
      <div className="flex flex-row ml-5 p-5 ">
        <div className="contact-icons flex items-center mr-5 p-3 shadow-lg rounded-lg bg-[#262626]">
          <svg
      ...
      <div className="flex flex-row justify-center">
        ...
        <a href="http://twitter.com" className=" m-2">
          <svg
            className="link w-6 h-6 text-gray-300  cursor-pointer"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
